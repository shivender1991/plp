	  ...
	  <div class="col-12">
		<div class="card">
		  ...
		  <div class="card-header-action">
		  	<a class="btn btn-outline-primary" href="{{ route('state.upload') }}">State SCED Upload Data</a>
			...
			<?php 
			 if($statescedData){
				...
				?>
				    ...
				    ?>
				    @if($tablecolumnHeaders->state_list_column_status == 1)
						<td data-toggle="tooltip" data-placement="top" data-original-title="<?php echo $statescedDatas->$name; ?>" ><?php  echo Illuminate\Support\Str::limit($statescedDatas->$name, 50); ?></td>
					@endif
